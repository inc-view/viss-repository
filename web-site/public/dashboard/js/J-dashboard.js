...
function graficoProdutividade() {
    var valor = localStorage.getItem('FK_EMPRESA')
    fetch(`/J-routes/graficoProdutividade?empresa=${valor}`, { cache: 'no-store' }).then(function (response) {
        if (response.ok) {
            response.json().then(function (resposta) {
                console.error(`Dados recebidos: ${JSON.stringify(resposta)}`);                
                var options = {
                  ...
                  var chart3 = new ApexCharts(document.querySelector("#chart2"), options2);
                  chart3.render();
            
                  var chart4 = new ApexCharts(document.querySelector("#chart3"), options3);
                  chart4.render();
            
                  var optionsCol = {
                      series: [{
                      name: 'Inflation', //{ hora_do_dia: 0, media_registro_PPM: '98.0000' }
                      data: [resposta[0].media_registro_PPM, resposta[1].media_registro_PPM, resposta[2].media_registro_PPM, resposta[3].media_registro_PPM, resposta[4].media_registro_PPM, resposta[5].media_registro_PPM, resposta[6].media_registro_PPM, resposta[7].media_registro_PPM, resposta[8].media_registro_PPM, resposta[9].media_registro_PPM, resposta[10].media_registro_PPM, resposta[11].media_registro_PPM, resposta[12].media_registro_PPM, resposta[13].media_registro_PPM, resposta[14].media_registro_PPM, resposta[15].media_registro_PPM, resposta[16].media_registro_PPM, resposta[17].media_registro_PPM, resposta[18].media_registro_PPM, resposta[19].media_registro_PPM, resposta[20].media_registro_PPM, resposta[21].media_registro_PPM, resposta[22].media_registro_PPM, resposta[23].media_registro_PPM]
                    }],
                      chart: {
                      height: 200,
                      type: 'bar',
                    ...
                    var chartCol = new ApexCharts(document.querySelector("#chartCol"), optionsCol);
                    chartCol.render();
...
function fazerListaInfoFuncionario() {
    ...
    fetch(`/J-routes/fazerListaInfoFuncionario?empresa=${valor}`, { cache: 'no-store' }).then(function (response) {
        if (response.ok) {
            response.json().then(function (resposta) {
